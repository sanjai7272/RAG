...
# RPM -> 2.0-flash = 50-100/min

# 3 APIs 

# Load docs -> just load the docs , chunk them , store them in a vector store
# response -> input -> retriever -> document chain -> answer 
# Delete vector store -> delete the vector store directory 
